...
dnf install -y --releasever=25 --installroot=/mnt/sysimage filesystem
...
https://github.com/dustymabe/fedora-grub-boot-btrfs-default-subvolume/raw/master/fedora25/rpmbuild/RPMS/x86_64/grub2-2.02-0.38.fc25.dusty.x86_64.rpm \
https://github.com/dustymabe/fedora-grub-boot-btrfs-default-subvolume/raw/master/fedora25/rpmbuild/RPMS/x86_64/grub2-tools-2.02-0.38.fc25.dusty.x86_64.rpm
